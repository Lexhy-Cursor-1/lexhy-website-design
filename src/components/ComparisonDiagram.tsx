...
const ComparisonDiagram = () => {
  return (
    <section className="py-22 bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-muted/30 border border-muted rounded-3xl p-8">
            <h3 className="text-3xl font-semibold text-muted-foreground mb-6 text-center">
              Usual Legal Tech Solutions
            </h3>
            
            <div className="flex flex-col items-center space-y-6">
              {/* Technology box */}
              <div className="bg-muted/60 border-2 border-muted-foreground/30 rounded-xl px-6 py-4 w-full max-w-md">
              ...
              {/* Law firms box */}
              <div className="bg-muted/80 border-2 border-muted-foreground/50 rounded-xl px-6 py-4 w-full max-w-md">
                <div className="flex items-center justify-center gap-3">
          ...
          {/* Lexhy Approach */}
          <div className="bg-gradient-retro-subtle border border-warm-sage/30 rounded-3xl p-8 relative overflow-hidden">
            ...
            <div className="flex flex-col items-center space-y-6">
              {/* Technology box */}
              <div className="bg-warm-sage/20 border-2 border-warm-sage/40 rounded-xl px-6 py-4 w-full max-w-md">
                <div className="flex items-center justify-center gap-3">
              ...
              {/* Business owners box */}
              <div className="bg-warm-terracotta/20 border-2 border-warm-terracotta/40 rounded-xl px-6 py-4 w-full max-w-md">
                <div className="flex items-center justify-center gap-3">
              ...
              <div className="bg-warm-gold/20 border-2 border-warm-gold/40 rounded-xl px-4 py-3 w-full max-w-md">
