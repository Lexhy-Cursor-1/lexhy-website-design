        ...
        <div className="max-w-6xl mx-auto text-center space-y-16">
          ...
          <div className="relative mb-20">
            <img 
              ...
              className="w-full max-w-4xl mx-auto rounded-3xl shadow-lg opacity-90 mb-10"
            />
          </div>
          ...
          <div className="mt-28">
            <p className="text-foreground/80 mb-10 text-lg uppercase tracking-wider font-light">Trusted by</p>
          ...
          {/* Client Testimonial */}
          <div className="mt-20 max-w-4xl mx-auto">
            <div className="bg-card/70 backdrop-blur-sm border border-border/50 rounded-2xl p-6 md:p-8">
